  ...
  fields: [
    {
      ...
      options: [
        ...
        {
          label: 'Konvertert til aktivitet',
          value: 'converted',
        },
        {
          label: 'Avvist',
    ...
    },
    {
      name: 'linkedActivity',
      type: 'relationship',
      label: 'Koblet aktivitet',
      relationTo: 'student-activities',
      admin: {
        description: 'Sett denne når tipset er gjort om til en publisert eller planlagt aktivitet.',
      },
    },
    {
      name: 'editorNotes',
      ...
      admin: {
        description: 'Kun for redaksjonell oppfølging.',
      },
    },
  ],
}